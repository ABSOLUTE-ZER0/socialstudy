          ...
          <div v-if="academics">
            ...
            <b-row class="comp">
              <div style="width:80%">
                ...
                <div style="border-top: 2.5px solid rgba(128, 128, 128, 0.568); margin:1em" v-for="item in certificate" :key="item">
                  <CardImg3 margin="3em !important" :src="item.src" :name="item.name" :sub1="item.year" :sub2="item.institute" />
                </div>
